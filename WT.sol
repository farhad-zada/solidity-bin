...
1) Create a multisignature wallet where a user can propose a transaction, 
vote on a transaction, and revoke their vote on a transaction. Transactions 
should automatically go through once 3/5 of the owners have signed.

2) Create a function where the input is an array of numbers, and the output 
is a string. Turn the array of numbers into a string, where 1 = a, 2 = b, and 3 = c.

I should be able to enter [20,8,5,15,4,15,18,5] and receive "THEODORE".
